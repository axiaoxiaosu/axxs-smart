...
import com.smart.api.service.UserService;
...
public class UserServiceImpl implements UserService {
  ...
  /*  @Transactional(rollbackFor = Exception.class)
    ...
    public LoginReponse login(LoginRequest vo) {
        ...
        MplUser user = userDetail.getUser();
        return new LoginReponse()
                .setToken(token)
                .setMenu(userDetail.getMplMenu())
                .setUser(new UserData(user.getUsername(), user.getNickName(), user.getPortrait(), user.getEmail(), user.getLastTime()));
    }
*/
    ...
    @Override
    public boolean deleteUser(MyUserDetail myUserDetail, List<Long> userIds) {
        //查询是否有菜单依赖于该项
