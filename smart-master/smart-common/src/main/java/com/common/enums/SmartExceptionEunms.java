...
public enum SmartExceptionEunms {
    ...
    PARAMETER_NULL(10007, "角色名称不能为空", "参数不能为空"),


    DELETE_ERROR(10007, "删除失败,请联系管理员", "删除失败"),
    ROLE_NOT_FIND(10008, "角色未找到", "角色未找到"),

    RORLE_BIND_USER(10009, "该角色绑定者用户,无法进行操作", "该角色绑定者用户,无法进行操作"),

    QUARTZ_NOTFINDJOB(2000, "没有找到该任务"),
    QUARTZ_JOBREMOVEERROR(2001, "任务删除失败");
    ...
    SmartExceptionEunms(int code, String msg) {
        this.code = code;
        this.msg = msg;
